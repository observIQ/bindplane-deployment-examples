...
| `subnet`           | The subnet to which the instance will be connected. | `default` |
| `image`            | The image to use for the boot disk.              | `projects/blue-medoras-public-project/global/images/bindplane-ee-1-95-1` |
